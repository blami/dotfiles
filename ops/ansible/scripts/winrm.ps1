...
param (
    ...
    # TODO: Add [switch]$Disable which will remove everything
)
...
# Certificates
Write-Host -ForegroundColor DarkGreen "* Installing certificates"
# Server certificate
...
Write-Host -ForegroundColor DarkYellow "> Installing server certificate ${ServerCertPath}"
...
# Client certificate
Write-Host -ForegroundColor DarkYellow "> Installing client certificate ${ClientCertPath}"
...
# WinRM
Write-Host -ForegroundColor DarkGreen "* Creating WinRM HTTPS listener"
# Service
...
# Listeners
Write-Host -ForegroundColor DarkYellow "> Creating HTTPS listener"
...
# Firewall
Write-Host -ForegroundColor DarkGreen "* Creating Firewall Rules for WinRM HTTPS"
...
# Certificate mapping
Write-Host -ForegroundColor DarkYellow "> Mapping certificate $($ClientCert.Thumbprint) to ${User}"
Get-ChildItem -Path WSMan:\localhost\ClientCertificate | Where-Object { $_.Keys -like "Issuer=$($ClientCert.Thumbprint)" } | Remove-Item -Recurse
